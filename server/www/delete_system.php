...
if(isset($_POST['confirmed']))
{
	...
	$result = mysql_query("delete from update_locks where system_id = '" . $_POST['system_id'] . "'");
	if(!$result)
	{
		die("Error: " . mysql_error());
	}
...
{	
	...
	$page_title = "Delete system?";
	require "inc/header.php";
?>
Are you sure you want to delete <?php echo $system_row['name'] ?>?<br />
